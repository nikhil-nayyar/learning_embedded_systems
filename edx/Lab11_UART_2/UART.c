...
// as part of Lab 11 implement this function
	...
	// Iterate through each character of string and output to UART
	int i = 0;
	while(buffer[i] != '\0'){
...
// as part of Lab 11 implement this function
	...
	// return 'null' if integer invalid
	if(n >= 10000){
		String[3] = '*';
		String[2] = '*';
		String[1] = '*';
	...
	// return formatted integer
		...
		while(exp >= 0){
			...
			// Generate Divisor for Digit
			int divisor = pow(base,exp);
			
			// Generate Digit
			int digit = dividend / divisor;
			dividend = dividend % divisor;
			
			// If the digit is nonzero, place in string
			if(digit != 0){
				hit = 1;
				String[3-exp] = (char) (48 + digit);
			} 
			
			// If digit is zero and at beginning, add space
			else if (hit == 0){
				String[3-exp] = ' ';
			}

			// If digit is zero and not at beginning, add zero
			else if (hit != 0){
				String[3-exp] = '0';
			}
...
// as part of Lab 11 implement this function
	...
	// Replace empty spaces with zeros as needed
	if(String[3] == ' '){String[3] = '0';}		
	if(String[2] == ' '){String[2] = '0';}
	if(String[1] == ' '){String[1] = '0';}
	if(String[0] == ' '){String[0] = '0';}
	
	// Format in centimeters using existing value stored in string
	String[7] = 'm';
	String[6] = 'c';
	String[5] = ' ';
	String[4] = String[3];
