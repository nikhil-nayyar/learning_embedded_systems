...
// as part of Lab 11 implement this function
  short i = 0;
	// Iterate through buffer while not null terminating character 
	while(buffer[i] != '\0'){
		// Output Char data
...
// as part of Lab 11 implement this function
	unsigned long dividend = n;
	unsigned long divisor = 1000;
	unsigned short leading = 1;
	int i;
	
	// If n too large, store **** to string
  if(n >= 10000){
		String[0] = '*';
		String[1] = '*';
		String[2] = '*';
		String[3] = '*';
		String[4] = '\0'; // Set last character to null 
		return;
	}
	...
	for(i = 3; i >= 0; i--){
		unsigned long q = dividend / divisor; // Get quotient
		unsigned long r = dividend % divisor; // Get remainder
		
		// If quotient is greater than 0, get ASCII char. Otherwise, fill in blank ASCII char
		if(q!=0){
			String[3-i] = (unsigned char) (48+q);
			leading = 0;
		} else if (q==0 && leading){
			String[3-i] = ' ';
		} else if (q==0 && !leading){
		...
		dividend = r; // Set new dividend to remainder
		divisor /= 10; // Decrement divisor by power of 10
...
// as part of Lab 11 implement this function
  ...
  if(n >= 10000){
		...
		String[3] = '*';
		String[4] = '*';
		String[5] = '\0'; // Set last character to null 
		return;
	}
